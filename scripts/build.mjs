...
for(const file of ['og.jpg','portrait.jpg','favicon.svg','world-2026.css','world-2026.js'])await cp('assets/'+file,'dist/assets/'+file);
await cp('images/IMG_5309.jpeg','dist/images/IMG_5309.jpeg');
